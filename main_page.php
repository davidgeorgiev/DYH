...
<?php
	...
	echo '<div id = "my_page" style = "background: rgba(163, 159, 158, 0.8);margin-top:2%;">';
  ...
  ?>
	...
	<?php
		...
		while ($row = mysql_fetch_array($result)){
			echo '<div id = "StandartBox" style = "margin:auto;margin-top:20px;">';
			echo '<h3 style = "font-size:30px;padding:20px;font-family:arial;">'.$row[0].'</h3>';
			echo '<p style = "font-size:20px;font-family:Arial;padding:20px;">'.FixURLsData($row[1]).'</p>';
			if ($EditMode == 1) {
