...
<?php
	...
	if ($EditMode == 1) {
		if (CheckIfHaveToShowOtherWeek(GetUserIDbyName($username))){
			echo DeactivateOtherWeek(GetUserIDbyName($username));
		} else {
			echo ActivateOtherWeek(GetUserIDbyName($username));
		}
	} else {
